            ...
            <ul class="horizontal-menu">
                            ...
                            <div class="row">
                                ...
                                <div class="col mega-box">
                                    <div class="link-section doted">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{ url('login-bs-validation') }}">Login with validation</a>
                                            </li>
                                ...
                                <div class="col mega-box">
                                    <div class="link-section">
                                        ...
                                        <ul>
                                            <li class="ps-0"><a href="{{ url('basic-template') }}">Basic
                                                    Email</a></li>
                                            <li class="ps-0"><a href="{{ url('email-header') }}">Basic With
                                                    Header</a></li>
                                            <li class="ps-0"><a href="{{ url('template-email') }}">Ecomerce
                                                    Template</a></li>
                                            <li class="ps-0"><a href="{{ url('template-email-2') }}">Email
                                                    Template 2</a></li>
                                            <li class="ps-0"><a
                                                    href="{{ url('ecommerce-templates') }}">Ecommerce Email</a></li>
                                            <li class="ps-0"><a
                                                    href="{{ url('email-order-success') }}">Order Success</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col mega-box">
                                    <div class="link-section">
                                        ...
                                        <ul class="svg-icon">
                                            <li><a href="{{ url('comingsoon') }}"> <i data-feather="file">
                                                    </i>Coming-soon</a></li>
                                            <li><a href="{{ url('comingsoon-bg-video') }}"> <i data-feather="film">
                                                    </i>Coming-video</a></li>
                                            <li><a href="{{ url('comingsoon-bg-img') }}"><i data-feather="image">
                                                    </i>Coming-Image</a></li>
                                        </ul>
                                        <div>
                                            <h6>Other Soon</h6>
                                        ...
                                        <ul class="svg-icon">
                                            <li><a class="txt-secondary" href="{{ url('sample-page') }}"> <i
                ...
                {{-- <li class="level-menu outside">
                    ...
                    <ul class="header-level-menu menu-to-be-close">
                        <li>
                            <a href="{{ url('file-manager') }}" data-original-title="" title=""> <i
                        ...
                        <li>
                            ...
                            <ul class="header-level-sub-menu">
                                ...
                                <li>
                                    <a href="{{ url('edit-profile') }}" data-original-title="" title=""> <i
                                            data-feather="user-minus"></i><span>User Edit</span></a>
                                </li>
                                <li>
                                    <a href="{{ url('user-cards') }}" data-original-title="" title=""> <i
                                            data-feather="user-check"></i><span>Users Cards</span></a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{ url('kanban') }}" data-original-title="" title=""> <i
                                    data-feather="airplay"></i><span>Kanban Board</span></a>
                        </li>
                        <li>
                            <a href="{{ url('bookmark') }}" data-original-title="" title=""> <i
                                    data-feather="heart"></i><span>Bookmark</span></a>
                        </li>
                        <li>
                            <a href="{{ url('social-app') }}" data-original-title="" title=""> <i
        ...
        <div class="nav-right col-8 pull-right right-header p-0">
          ...
          <div class="translate_wrapper">
            ...
            <div class="more_lang">
              ...
              <a href="{{ url('lang', 'de') }}" class="{{ App::getLocale() == 'de' ? 'active' : '' }} ">
              ...
              <a href="{{ url('lang', 'es') }}" class="{{ App::getLocale() == 'en' ? 'active' : '' }}">
              ...
              <a href="{{ url('lang', 'fr') }}" class="{{ App::getLocale() == 'fr' ? 'active' : '' }}">
              ...
              <a href="{{ url('lang', 'cn') }}" class="{{ App::getLocale() == 'cn' ? 'active' : '' }}">
              ...
              <a href="{{ url('lang', 'ae') }}" class="{{ App::getLocale() == 'ae' ? 'active' : '' }}">
        ...
        <li class="onhover-dropdown">
          ...
          <ul class="chat-dropdown onhover-show-div">
            ...
            <li class="text-center"> <a class="btn btn-primary" href="#">View All     </a></li>
                ...
                <li class="profile-nav onhover-dropdown p-0 me-md-4" style="display: block !important;">
